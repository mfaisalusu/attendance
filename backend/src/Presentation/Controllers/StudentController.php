...
class StudentController extends BaseController
{
    ...
    public function index(Request $request): void
    {
        ...
        try {
            ...
            JsonResponse::error('Gagal memuat data mahasiswa.', 500);
        }
    }
    ...
    public function update(Request $request): void
    {
        ...
        try {
            ...
            JsonResponse::error('Gagal memperbarui data mahasiswa.', 500);
        }
    }
    ...
    public function destroy(Request $request): void
    {
        ...
        try {
            $useCase = new DeleteStudentUseCase(new StudentRepository());
            $useCase->execute($studentId, $userId);

            JsonResponse::success(null, 'Mahasiswa berhasil dihapus.');
        } catch (RuntimeException $e) {
            JsonResponse::notFound($e->getMessage());
        } catch (Throwable) {
            JsonResponse::error('Gagal menghapus mahasiswa.', 500);
        }
    }
}
